...
#define ORIGINAL_FILE_NAME "UE4Editor-darudeSandstorm.dylib"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME darudeSandstorm
#define DEPRECATED_FORGAME DEPRECATED
#define DARUDESANDSTORM_API DLLEXPORT
